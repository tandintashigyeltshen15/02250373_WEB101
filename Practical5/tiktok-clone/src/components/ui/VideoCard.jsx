...
const VideoCard = ({ video }) => {
  ...
  const handleVideoError = (e) => {
    ...
    // Only show error if it's a real network failure (networkState 3 = NETWORK_NO_SOURCE)
    if (!videoEl.src || videoEl.networkState === 3) {
      console.error("Video failed to load:", videoEl.src);
      setVideoError(true);
    }
  };
